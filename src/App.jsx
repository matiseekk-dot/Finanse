...
// group: "essential" = stałe/ważne, "lifestyle" = dodatkowe, "income" = przychody
  ...
  return (
    <div style={{ padding: "0 16px 100px" }}>
      ...
      <div style={{ display: "flex", gap: 8, paddingTop: 8, paddingBottom: 14 }}>
        {[["month","📅 Bieżący"],["period","📊 Okresy"]].map(([v,l]) => (
        ...
        <div>
          ...
          <div style={{ display: "flex", gap: 8, marginBottom: 14 }}>
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 10, color: "#475569", fontWeight: 700,
                textTransform: "uppercase", marginBottom: 6 }}>Grupuj po</div>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 10, color: "#475569", fontWeight: 700,
                textTransform: "uppercase", marginBottom: 6 }}>Sortuj</div>
              <div style={{ display: "flex", gap: 4 }}>
                {[["total","Kwota"],["count","Ilość"],["avg","Śr."]].map(([v,l]) => (
          ...
          <Card>
            <div style={{ fontSize: 11, color: "#64748b", fontWeight: 700,
              ...
              {groupBy === "cat" ? "Kategorie" : "Miejsca"} · {PERIOD_LABELS[period]}
    ...
    <Card style={{ marginBottom: 14 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
        ...
        <div style={{ fontFamily: "'DM Mono', monospace", fontSize: 11, color: "#475569" }}>
          {toStr(weekAgo).slice(5).replace("-","/")} - {today.slice(5).replace("-","/")}
        </div>
      </div>
